...
import it.arsinfo.opennms.plugins.otrs6.clients.ClientCredentials;
...
public class ConnectionManager {
    ...
    private static final String PREFIX = "otrs_6_connection_";
    ...
    public Connection newConnection(final String url, final String username, final String password, final boolean ignoreSslCerticateValidation) {
        ...
        return new ConnectionImpl(ClientCredentials.builder()
                .withUrl(url)
    ...
    private static ClientCredentials fromStore(final Credentials credentials) {
    ...
    private class ConnectionImpl implements Connection {
        ...
        private ConnectionImpl(final ClientCredentials credentials) {
        ...
        public void setIgnoreSslCertificateValidation(boolean ignoreSslCertificateValidation) {
            this.credentials = ClientCredentials.builder(this.credentials)
                    .withIgnoreSslCertificateValidation(ignoreSslCertificateValidation)
                    .build();
        }
        ...
        public void setUrl(final String url) {
            this.credentials = ClientCredentials.builder()
                                                            .withUrl(url)
                                                            .build();
        }
        @Override
